...
export const REST_PLANIFICACION_MOVER = "/api/planificacion/mover";
export const REST_ASIGNAR = (id: string) => `/api/trips/${encodeURIComponent(id)}/asignar`;
export const REST_ENVIAR = (id: string) => `/api/trips/${encodeURIComponent(id)}/enviar`;
export const REST_QUITAR_TERMINAL = (id: string) => `/api/trips/${encodeURIComponent(id)}/quitar-terminal`;
...
export const REST_FACTURABLES = "/api/contabilidad/facturables";
export const REST_FACTURAS = "/api/contabilidad/facturas";
export const REST_FACTURA_AGRUPADA = "/api/contabilidad/facturas/agrupada";
export const REST_FACTURA_GENERAR = (id: string) => `/api/contabilidad/facturas/${encodeURIComponent(id)}`;
export const REST_FACTURA_PDF = (id: number) => `/api/contabilidad/facturas/${id}/pdf`;
export const REST_FACTURA_COBRAR = (id: number) => `/api/contabilidad/facturas/${id}/cobrar`;
export const REST_FACTURA_ENVIAR = (id: number) => `/api/contabilidad/facturas/${id}/enviar`;
...
export const REST_TRIP = (id: string) => `/api/trips/${encodeURIComponent(id)}`;
export const REST_ACTIVITY_TYPES = "/api/activity-types";
export const REST_REVERSE_GEOCODE = "/api/reverse-geocode";
