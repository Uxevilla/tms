...
@app.patch("/api/empleados/{emp_id}")
...
@app.get("/api/nominas/{nomina_id}/pdf")
...
@app.get("/api/nominas/{nomina_id}/lineas")
...
@app.patch("/api/nominas/{nomina_id}")
...
@app.delete("/api/nominas/{nomina_id}")
...
@app.post("/api/nominas/{nomina_id}/contabilizar")
...
@app.post("/api/nominas/{nomina_id}/pagar")
...
@app.patch("/api/ausencias/{aus_id}")
...
@app.get("/api/empleados/ausencias")
...
@app.post("/api/empleados/ausencias")
...
@app.delete("/api/empleados/ausencias/{ausencia_id}")
...
@app.delete("/api/ausencias/{aus_id}")
